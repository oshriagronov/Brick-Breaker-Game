...
public final class AssetPaths {
    ...
    // sound effect assets
    public static final String COLLISION_SOUND_EFFECT_FILE_PATH = "assets/Bubble5_4.wav";
    public static final String BRICK_COLLISION_SOUND_EFFECT_FILE_PATH = "assets/blop_cut_silenced.wav";
    // error
    public static final String ERROR_ICON_PATH = "assets/error.png";
}
